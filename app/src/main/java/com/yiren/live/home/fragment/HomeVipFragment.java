package com.yiren.live.home.fragment;
...
import com.yiren.live.base.BaseSiSiFragment;
import com.yiren.live.home.adapter.HotRecyclerListAdapter;
import com.yiren.live.home.intf.OnRecyclerViewItemClickListener;
import com.yiren.live.home.model.BannerItem;
import com.yiren.live.home.model.VideoItem;
import com.yiren.live.home.view.CustomSwipeRefreshLayout;
import com.yiren.live.intf.OnCustomClickListener;
import com.yiren.live.intf.OnRequestDataListener;
import com.yiren.live.living.LivingActivity;
 ...
 * 2017/6/21 21:32
 */
public class HomeVipFragment extends BaseSiSiFragment implements OnRecyclerViewItemClickListener {
    ...
    public static HomeVipFragment getInstance(int pos) {
                ...
                public void requestSuccess(int code, JSONObject data) {
                    if (isActive) {
                        ...
                        for (int i = 0; i < list.size(); i++) {
                            ...
                            videoItem.setCharge_type(item.getString("charge_type"));
                            mVideoItems.add(videoItem);
                        }
