...
import com.live.xue.base.BaseSiSiFragment;
import com.live.xue.home.adapter.HotRecyclerListAdapter;
import com.live.xue.home.intf.OnRecyclerViewItemClickListener;
import com.live.xue.home.model.BannerItem;
import com.live.xue.home.model.VideoItem;
import com.live.xue.home.view.CustomSwipeRefreshLayout;
...
//        toast("mposition "+mPosition+"  isDragonGame "+isDragonGame);
        if (mVideoItems == null) {
...
//        convenientBanner.startTurning(3000);
    ...
    private void getData(int limit_begin, int limit_num, final SwipeRefreshLayout mSwipeRefreshLayout) {
        ...
        if (!StringUtils.isEmpty(token) && !StringUtils.isEmpty(userId)) {
            ...
            requestParams.put("type", isDragonGame? 9:5);
        ...
        if (StringUtils.isNotEmpty(item.getPrice()) && Integer.parseInt(item.getPrice()) > 0) {
            ...
            DialogEnsureUtiles.showConfirm(getActivity(), "该房间需要收费" + item.getPrice(), new OnCustomClickListener() {
                ...
                public void onClick(String value) {
                    ...
                    data.putString("type",isDragonGame? "longhu":"bai");
                ...
                public void onClick(final String value) {
                    ...
                    Api.checkPass(getContext(), params, new OnRequestDataListener() {
                        ...
                        public void requestSuccess(int code, JSONObject data) {
                            ...
                            data1.putString("type", isDragonGame? "longhu":"bai");
