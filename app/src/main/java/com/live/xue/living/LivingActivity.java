...
import com.live.xue.game.GameLongHuActivity;
...
import com.live.xue.MainActivity;
import com.live.xue.MyApplication;
import com.live.xue.game.GameActivity;
...
import com.live.xue.lean.Chat;
import com.live.xue.lean.ConversationListActivity;
import com.live.xue.own.UserMainActivity;
import com.live.xue.own.WebviewActivity;
import com.live.xue.own.userinfo.ContributionActivity;
import com.live.xue.utils.Api;
import com.live.xue.utils.DialogEnsureUtiles;
import com.live.xue.utils.FunctionUtile;
import com.live.xue.view.AlwaysMarqueeTextView;
import com.live.xue.view.BubbleView;
...
public class LivingActivity extends BaseActivity implements TextureView.SurfaceTextureListener, AdapterView.OnItemClickListener, View.OnClickListener, OnShareStatusListener {
    ...
    public List<com.live.xue.living.GiftSendModel> giftSendModelList = new ArrayList<com.live.xue.living.GiftSendModel>();
    ...
    @Bind(R.id.tv_baijiale)
    TextView tv_baijiale;
...
//                        .into(mDialogUserAvatarSmall);
    ...
    private void setOrition(){
        if ("bai".equals(type) || "longhu".equals(type)) {
...
//        EventBus.getDefault().register(this);
        ...
        setOrition();
        Logs.e("setRotateDegree onResume");
            ...
            if (isActive) {
                mRTCAuthResponse = new AuthHttpTask.KSYOnHttpResponse() {
                    ...
                    public void onHttpResponse(int responseCode, final String response) {
                        Log.e(TAG,"onRTCRegisterClick code "+responseCode+"  "+response);
                        if (responseCode == 200) {
